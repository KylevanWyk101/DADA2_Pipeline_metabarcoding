...
directory = "C:/University/2025/kyle_research_project/Data_processing/Seq_data/master_F_trnl/trimmed_trnl"

# Define the output manifest file paths
impala_manifest_file = "C:/University/2025/kyle_research_project/Data_processing/Seq_data/master_F_trnl/trimmed_trnl/impala_manifest_trnll.tsv"
elephant_manifest_file = "C:/University/2025/kyle_research_project/Data_processing/Seq_data/master_F_trnl/trimmed_trnl/elephant_manifest_trnl.tsv"

# Define sample IDs for each group
impala_samples = [f"{i}-trnl" for i in range(25, 49)] + ["C1-trnl"]
elephant_samples = [f"{i}-trnl" for i in range(49, 73)] + ["C3-trnl"]
